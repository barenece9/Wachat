 ...
 */
public class AsyncUnblockUser extends AsyncTask<Void, Void, Void> {
...
//    private Context mContext;
    ...
    public AsyncUnblockUser(String userId, String friendChatId, String blockStatus, InterfaceResponseCallback mCallback) {
