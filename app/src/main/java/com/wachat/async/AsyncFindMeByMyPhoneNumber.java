 ...
 */
public class AsyncFindMeByMyPhoneNumber extends AsyncTask<Void, Void, Void> {
    private InterfaceResponseCallback mCallback;
    private String userId, status = "";
    private Throwable mException;
    private BaseResponse mBaseResponse;

    public AsyncFindMeByMyPhoneNumber(String userId, String status, InterfaceResponseCallback mCallback) {
        this.userId = userId;
        this.status = status;
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            HttpConnectionClass mHttpConnectionClass = new HttpConnectionClass(WebContstants.UrlFindMeByMyPhoneNumber);
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if (mBaseResponse != null) {
            ...
            String error = "";
            if (mException != null) {
                error = CommonMethods.getAlertMessageFromException(AppVhortex.getInstance().getApplicationContext(), mException);
            }
