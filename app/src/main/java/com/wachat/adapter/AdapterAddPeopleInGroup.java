 ...
 */
public class AdapterAddPeopleInGroup extends RecyclerView.Adapter<AdapterAddPeopleInGroup.VH> implements View.OnClickListener {
//    int count = 0;
//    Context mContext;
    ...
    public AdapterAddPeopleInGroup(Context mContext,
...
//        final DataContactForGroup mDataContact = ;
        String name = (mListContact.get(position).getAppName().equals("")) ? ((mListContact.get(position).getName().equals("")) ? mListContact.get(position).getPhoneNumber() : mListContact.get(position).getName()) : mListContact.get(position).getAppName();
