...
import com.wachat.R;
import com.wachat.activity.ActivityYoutubePlayer;
...
public class AdapterYouTubeVideoList extends RecyclerView.Adapter<AdapterYouTubeVideoList.VH> {
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VH((LayoutInflater.from(parent.getContext())).inflate(R.layout.inflater_video_list, parent, false));
    }
    ...
    public void onBindViewHolder(VH holder, final int position) {
        ...
        holder.tv_time.setText(DateTimeUtil.getFormattedDate(youTubeVideo.getPublishTime(), "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", "MMMM d, yyyy"));
