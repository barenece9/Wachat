...
/**
 * Created by Priti Chatterjee on 01-09-2015.
 */
public class AdapterImageSelection extends RecyclerView.Adapter<AdapterImageSelection.VH> {
    ...
    public AdapterImageSelection(Context mContext, ImageLoader mImageLoader,
                                 ArrayList<DataShareImage> mListString, int width, StartActivityResult mCallBack, boolean isCamera) {
    ...
    public ArrayList<DataShareImage> getList() {
