...
public class AdapterYahooNewsList extends RecyclerView.Adapter<AdapterYahooNewsList.VH> {
    ...
    private ArrayList<DataYahooNews> dataYahooNewses;
    ...
    public void onBindViewHolder(VH holder, final int position) {
        ...
        final DataYahooNews yahooNews = dataYahooNewses.get(position);
        ...
        String time = DateTimeUtil.getFormattedDate(yahooNews.getPubDate(), "ccc, dd MMM yyyy HH:mm:ss Z", "ccc, dd MMM yyyy HH:mm");
...
//            holder.itemView.setBackgroundColor(mContext.getResources().getColor(R.color.yahoo_news_bg_dark));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    e.printStackTrace();
                    ToastUtils.showAlertToast(mContext, mContext.getString(R.string.alert_failure_yahoo_not_found), ToastType.FAILURE_ALERT);
                }
            }
        });
    }
    ...
    public void refreshList(ArrayList<DataYahooNews> dataYahooNewses) {
        this.dataYahooNewses = dataYahooNewses;
        this.notifyDataSetChanged();
    }

    public interface OnItemClickListener {
        void onClick(DataYahooNews itemData, int itemPosition);
    }
