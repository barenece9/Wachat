...
public class ChatGridLayoutManager extends GridLayoutManager {

	public ChatGridLayoutManager(Context context, int spanCount,
	...
	private void measureScrapChild(Recycler recycler,
