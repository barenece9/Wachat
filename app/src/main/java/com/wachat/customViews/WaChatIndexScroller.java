...
public class WaChatIndexScroller {
	...
	public WaChatIndexScroller(Context context, ListView lv) {
		mDensity = context.getResources().getDisplayMetrics().density;
		mScaledDensity = context.getResources().getDisplayMetrics().scaledDensity;
		mListView = lv;
		setAdapter(mListView.getAdapter());

		mIndexbarWidth = 15 * mDensity;
	...
	public void draw(Canvas canvas) {
		...
		indexbarPaint.setColor(context.getResources().getColor(R.color.transluscent_white));
//		indexbarPaint.setAlpha((int) (64 * mAlphaRate));
		...
		if (mSections != null && mSections.length > 0) {
			...
			if (mCurrentSection >= 0) {
				...
				previewPaint.setColor(context.getResources().getColor(R.color.app_Brown));
				previewPaint.setAlpha(96);
				previewPaint.setAntiAlias(true);
				previewPaint.setShadowLayer(3, 0, 0, Color.argb(64, 0, 0, 0));

				Paint previewTextPaint = new Paint();
				previewTextPaint.setColor(context.getResources().getColor(R.color.app_Brown));
	...
	public void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		mListView.setPadding(
				...
				mListView.getPaddingTop(), Math.round((mIndexbarMargin + mIndexbarWidth)),
