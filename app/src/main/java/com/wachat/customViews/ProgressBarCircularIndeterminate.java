...
public class ProgressBarCircularIndeterminate extends CustomView {
    ...
    protected void onInitDefaultValues() {
        minWidth = (int) getResources().getDimension(R.dimen.medium_brush);
        minHeight = (int) getResources().getDimension(R.dimen.medium_brush);
        backgroundColor = Color.parseColor("#111E35");
    }
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        if (width != null) {
            ...
            width = attrs.getAttributeValue(MATERIALDESIGNXML, "cpb_strokeWidth");
            if (width != null) {
                size = Utils.dipOrDpToFloat(width);
            }
        }
