 ...
 * SDK: Create a Drawing App - extended for follow-up tutorials on using
 * patterns and opacity
 * <p/>
 * Sue Smith August 2013 / September 2013
 */
public class DrawingView extends View {
    ...
    // initial color
    private int paintColor = 0xff0000, paintAlpha = 255;
    // canvas
    ...
    public void setErase(boolean isErase) {
        erase = isErase;
        if (erase) {
             PorterDuffXfermode mDuffXfermode = new PorterDuffXfermode(
             PorterDuff.Mode.CLEAR);
             PorterDuffColorFilter mColorFilter = new PorterDuffColorFilter(
             Color.WHITE, PorterDuff.Mode.CLEAR);
             drawPaint.setColorFilter(mColorFilter);
            drawPaint.setXfermode(mDuffXfermode);

//            drawPaint.setColor(Color.WHITE);
////            drawPaint.setARGB(1, 1, 1, 1);
